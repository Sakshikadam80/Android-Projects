...
public class questionAdapter1 extends RecyclerView.Adapter<questionAdapter1.QuestionVH> {


    List<sample1> sampleList;

    public questionAdapter1(List<sample1> sampleList) {
    ...
    public void onBindViewHolder(@NonNull QuestionVH holder, int position) {
        ...
        sample1 samples = sampleList.get(position);
        ...
        public QuestionVH(@NonNull View itemView) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    sample1 samples = sampleList.get(getAdapterPosition());
