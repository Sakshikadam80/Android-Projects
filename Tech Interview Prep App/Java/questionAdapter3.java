...
public class questionAdapter3 extends RecyclerView.Adapter<questionAdapter3.QuestionVH> {

    List<sample3> sampleList;

    public questionAdapter3(List<sample3> sampleList) {
    ...
    public void onBindViewHolder(@NonNull QuestionVH holder, int position) {
        ...
        sample3 samples = sampleList.get(position);
        ...
        public QuestionVH(@NonNull View itemView) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    sample3 samples = sampleList.get(getAdapterPosition());
