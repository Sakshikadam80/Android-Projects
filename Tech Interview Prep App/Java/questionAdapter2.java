...
public class questionAdapter2 extends RecyclerView.Adapter<questionAdapter2.QuestionVH> {


    List<sample2> sampleList;
     public questionAdapter2(List<sample2> sampleList){
   ...
   @Override
    public void onBindViewHolder(@NonNull QuestionVH holder, int position){
         ...
         sample2 samples = sampleList.get(position);
       ...
       public QuestionVH(@NonNull View itemView) {
           ...
           linearLayout.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   sample2 samples = sampleList.get(getAdapterPosition());
